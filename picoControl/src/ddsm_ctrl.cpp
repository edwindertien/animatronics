...
// FIXED: was using hardcoded Serial1 instead of pSerial
int DDSM_CTRL::ddsm115_fb() {
  ...
  uint8_t data[10];
  pSerial->readBytes(data, 10);   // was: Serial1.readBytes() — bug fixed
...
// change mode
// ddsm115: 1=current loop, 2=speed loop, 3=position loop
// ddsm210: 0=open loop,    2=speed loop, 3=position loop
...
// ddsm210 speed loop: cmd -2100..+2100 → -210..+210 rpm
