...
// //     Action(SW(7,2), 15, DIRECT, nullptr, 100, 15, &player2),   // [11] elevator release -> vleugeldeur
// //     Action(KEY_ACTION(KEY_BIT_1), 13, DIRECT),                 // [12] elevator release back  -> adem
// //     Action(SW(4,1),  8, DIRECT, nullptr, 100, 13, &player2),   // [13] vleugeldeur -> grill
// //     Action(SW(4,2),  9, DIRECT, nullptr, 100, 13, &player2),   // [14] vleugeldeur terug -> niets
...
// //     Action(KEY_ACTION(KEY_BIT_3),  12, DIRECT),          // [18] toet2 -> vlieg omhoog
