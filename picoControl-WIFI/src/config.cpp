...
Action myActionList[NUM_ACTIONS] = {
  ...
  Action('2',  2, DIRECT, nullptr, 100, 2, &player1), // track 2
...
// ActionSequence jaws(24, DIRECT, true);   // button '5', toggle, loop

// // Sequence wiring for SCUBA
// void configureSequences() {
//     jaws.addEvent(0,   EVENT_START, &myActionList[15]); // hoofd
//     jaws.addEvent(1,   EVENT_START, &myActionList[21]); // adem
//     jaws.addEvent(5000, EVENT_STOP,  &myActionList[15]); // hoofd
//     jaws.addEvent(5001, EVENT_START,  &myActionList[16]); // grill
//     jaws.addEvent(8009, EVENT_STOP,  &myActionList[16]); // grill
//     jaws.addEvent(12000, EVENT_START, &myActionList[15]); // hoofd
//     jaws.addEvent(15000, EVENT_STOP, &myActionList[15]); // hoofd
//     jaws.addEvent(20000, EVENT_STOP, &myActionList[15]); // hoofd
// }
#endif // SCUBA
...
// And this is the single, real definition of the sequence
ActionSequence looking(24, DIRECT, true);   // button '5', toggle, loop
